...
class EOSGMultiplayerPeer : public MultiplayerPeer {
    GDCLASS(EOSGMultiplayerPeer, MultiplayerPeer)
...
public:
    ...
    virtual MultiplayerPeer::TransferMode get_packet_mode() const override;
    virtual void set_transfer_channel(int p_channel) override;
    virtual int get_transfer_channel() const override;
    virtual void set_transfer_mode(MultiplayerPeer::TransferMode p_mode) override;
    virtual MultiplayerPeer::TransferMode get_transfer_mode() const override;
    ...
    virtual MultiplayerPeer::ConnectionStatus get_connection_status() const override;
