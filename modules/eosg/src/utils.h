...
static Variant eosg_lobby_attribute_data_to_dict(EOS_Lobby_AttributeData *attributeData) {
    ...
    switch (attributeData->ValueType) {
        ...
        case EOS_EAttributeType::EOS_AT_STRING:
            ...
            break;
        default:
            ERR_PRINT(vformat("Error: EOSG Utils: eosg_lobby_attribute_data_to_dict: Unknown value type: %d", static_cast<int>(attributeData->ValueType)));
            break;
    }
...
static Variant eosg_sessions_attribute_data_to_dict(EOS_Sessions_AttributeData *attributeData) {
    ...
    switch (attributeData->ValueType) {
        ...
        case EOS_EAttributeType::EOS_AT_STRING:
            ...
            break;
        default:
            ERR_PRINT(vformat("Error: EOSG Utils: eosg_sessions_attribute_data_to_dict: Unknown value type: %d", static_cast<int>(attributeData->ValueType)));
            break;
    }
