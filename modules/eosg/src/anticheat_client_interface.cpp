...
int IEOS::anticheat_client_interface_add_external_integrity_catalog(Ref<RefCounted> p_options) {
    ...
    CharString p_path_globalized = ProjectSettings::get_singleton()->globalize_path(p_path_to_bin_file.get_data()).utf8();
    options.PathToBinFile = p_path_globalized.get_data();
