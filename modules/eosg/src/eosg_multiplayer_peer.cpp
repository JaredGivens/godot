 ...
 ****************************************/
Error EOSGMultiplayerPeer::get_packet(const uint8_t **r_buffer, int &r_buffer_size) {
 ...
 * peer.
 ****************************************/
Error EOSGMultiplayerPeer::put_packet(const uint8_t *p_buffer, int p_buffer_size) {
    ...
    ERR_FAIL_COND_V_MSG(p_buffer_size > get_max_packet_size(), ERR_UNAVAILABLE, "Failed to send packet. Packet size exceeds limits.");
    ERR_FAIL_COND_V(active_mode == MODE_CLIENT && !peers.has(1), ERR_BUG);

    uint8_t channel;
    uint8_t tr_channel = get_transfer_channel();
    channel = CH_RELIABLE;
    ...
    Error result;
    if (is_server() || active_mode == MODE_MESH) {
        if (target_peer == 0) {
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_available_packet_count() const {
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_max_packet_size() const {
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_packet_channel() const {
 ...
 * avaialble packet in the packet queue.
 ****************************************/
MultiplayerPeer::TransferMode EOSGMultiplayerPeer::get_packet_mode() const {
 ...
 ****************************************/
void EOSGMultiplayerPeer::set_transfer_channel(int p_channel) {
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_transfer_channel() const {
 ...
 ****************************************/
void EOSGMultiplayerPeer::set_transfer_mode(MultiplayerPeer::TransferMode p_mode) {
 ...
 * this multiplayer instance.
 ****************************************/
MultiplayerPeer::TransferMode EOSGMultiplayerPeer::get_transfer_mode() const {
 ...
 ****************************************/
void EOSGMultiplayerPeer::set_target_peer(int p_peer) {
    target_peer = p_peer;
}
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_packet_peer() const {
 ...
 ****************************************/
bool EOSGMultiplayerPeer::is_server() const {
 ...
 ****************************************/
void EOSGMultiplayerPeer::close() {
    if (!_is_active()) {
        return;
    }
 ...
 ****************************************/
void EOSGMultiplayerPeer::disconnect_peer(int p_peer, bool p_force) {
 ...
 ****************************************/
int EOSGMultiplayerPeer::get_unique_id() const {
    return unique_id;
}
 ...
 ****************************************/
void EOSGMultiplayerPeer::set_refuse_new_connections(bool p_enable) {
 ...
 ****************************************/
bool EOSGMultiplayerPeer::is_refusing_new_connections() const {
 ...
 ****************************************/
bool EOSGMultiplayerPeer::is_server_relay_supported() const {
 ...
 ****************************************/
MultiplayerPeer::ConnectionStatus EOSGMultiplayerPeer::get_connection_status() const {
...
Error EOSGMultiplayerPeer::_broadcast(const EOSGPacket &packet, int exclude) {
    ERR_FAIL_COND_V_MSG(packet.packet_size() > get_max_packet_size(), ERR_OUT_OF_MEMORY, "Failed to send packet. Packet exceeds max size limits.");
